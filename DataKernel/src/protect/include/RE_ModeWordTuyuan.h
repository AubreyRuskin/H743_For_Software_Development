...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_ModeWordTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的方式字元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_ModeWordTuyuan_H
#define RE_ModeWordTuyuan_H
...
typedef  struct
{
    ...
    /*定义输出的录波逻辑标识   */
    char   aStrLuboIDArr[32][MAX_LOGID_STR_LEN+1];

    /*定义输出的标志逻辑标识   */
    char   aStrFlagIDArr[32][MAX_LOGID_STR_LEN+1];

    /*定义输出的遥信逻辑标识   */
    char   aStrYaoxinIDArr[32][MAX_LOGID_STR_LEN+1];

}  ModeWord_Init_Node_Type;
...
typedef  struct
{
    ...
    */
    ...
    EP_ELEM_IO *   pInArr0;/*输入数据指针*/

    /* 输出量数组，存放本图元输出结果 */
    EP_ELEM_IO   ioOutArr[32];

}  ModeWord_Scan_Node_Type;
...
extern void     RE_ModeWordTuyuanScan(NODE  *pElemScanNode);
