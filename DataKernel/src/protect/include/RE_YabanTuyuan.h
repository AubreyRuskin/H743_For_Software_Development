...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_YabanTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的压板元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_YabanTuyuan_H
#define RE_YabanTuyuan_H
...
typedef  struct
{
    ...
    /*  定义压板的逻辑标识 */
    char   strYabanID[MAX_LOGID_STR_LEN+1];

}  Yaban_Init_Node_Type;
...
typedef  struct
{
    ...
    */
    ...
    int16_t   nYabanNum;/* 该压板在压板集中的序号 */

    BOOL   bYabanCurValue;/* 压板的当前值 */
    ...
    /* 当前扫描需要刷新定值标志的指针 */
    BOOL *pbCurScanDingzhiRreshFlag;

}  Yaban_Scan_Node_Type;
...
/*    返回值，无   */
extern void     RE_YabanTuyuanScan(NODE *pElemScanNode);
