...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_ConstZeroTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的恒0元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_ConstZeroTuyuan_H
#define RE_ConstZeroTuyuan_H
...
__inline__  static   void     RE_ConstZeroTuyuanScan(NODE *pElemScanNode)
{
