...
#ifndef RE_NotTuyuan_H
#define RE_NotTuyuan_H
...
__inline__  static   void     RE_NotTuyuanScan(NODE *pElemScanNode)
{

    (( Not_Scan_Node_Type   *)pElemScanNode->pTuyuan)->ioOut.now.bVal=
        !(((Not_Scan_Node_Type   *)pElemScanNode->pTuyuan)->pInArr0->now.bVal);
