...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_ConstOneTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的恒1元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_ConstOneTuyuan_H
#define RE_ConstOneTuyuan_H
...
__inline__  static   void     RE_ConstOneTuyuanScan(NODE *pElemScanNode)
{
