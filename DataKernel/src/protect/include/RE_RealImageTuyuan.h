...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_RealImageTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的实部虚部元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_RealImageTuyuan_H
#define RE_RealImageTuyuan_H
 ...
 *     NONE.
 */
extern void RE_RealImageTuyuanScan2(NODE *pElemScanNode);
...
extern void     RE_RealImageTuyuanScan(int  iInterval,NODE  *pElemScanNode);
