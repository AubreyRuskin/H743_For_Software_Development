...
/*       文件名                                           版本                 */
/*                                                                              */
/*      RE_RelayStartTuyuan.h                                    1.0                   */
/*                                                                              */
/*                                                                               */
/*     文件描述                                                                  */
/*                                                                              */
/*       该头文件定义了保护功能模块中的保护启停元件的文件头                        */
/*                                                                              */
/*      作者                                                                      */
/*                                                                              */
/*      张云                                                                  */
...
#ifndef RE_RelayStartTuyuan_H
#define RE_RelayStartTuyuan_H
...
}  RelayStart_Init_Node_Type;


/*跳闸允许外部输出图元扫描时的数据结构节点    */
typedef  struct
{
...
}  TripEnableOuterOutput_Scan_Node_Type;
...
/*  在读取文件后,进行AI目的地类型的相关未能从文件中获得的其他信息的初始化
      ...
      返回值,成功,返回真,失败返回假
*/
BOOL      RE_RelayStartTuyuanAIDestReadFileOtherInit
(RelayStart_Init_Node_Type * pElemInitNode);
