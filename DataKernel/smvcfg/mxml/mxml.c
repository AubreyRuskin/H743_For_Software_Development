/*
 * "$Id: mxml.c,v 1.1.4.1 2011/05/25 07:16:02 xu.difei Exp $"
 *
...
/*
 * End of "$Id: mxml.c,v 1.1.4.1 2011/05/25 07:16:02 xu.difei Exp $".
 */
...
const char	*mxmlElementGetValue(mxml_node_t *node)
{
    ...
    if (!node || !node->child||node->type != MXML_ELEMENT||node->child->type!=MXML_TEXT)
        return (NULL);
